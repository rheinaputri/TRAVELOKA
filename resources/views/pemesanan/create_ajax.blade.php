<form action="{{ url('/pemesanan/ajax') }}" method="POST" id="form-tambah">
    @csrf
            ...
            <form action="{{ url('/pemesanan/ajax') }}" method="POST" id="form-tambah">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <select name="id_wisatawan" id="id_wisatawan" class="form-control" required>
                            ...
                            @foreach ($wisatawans as $wisatawan)
                                <option value="{{ $wisatawan->id_wisatawan }}">{{ $wisatawan->nama_wisatawan }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input value="" type="date" name="tanggal_berangkat" id="tanggal_berangkat" class="form-control"
                            required>
                        <small id="error-tanggal_berangkat" class="error-text form-text text-danger"></small>
                    </div>
                    <div class="form-group">
                        <label>Tanggal Kembali</label>
                        <input value="" type="date" name="tanggal_kembali" id="tanggal_kembali" class="form-control"
                            required>
